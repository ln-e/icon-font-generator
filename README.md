...
```
npm install -g @ln-e/icon-font-generator
```
...
```
npx @ln-e/icon-font-generator my-icons/*.svg -o icon-dist
```
...
Copyright (c) 2014-2019 Workshape.io Ltd. - Released under the [MIT license](https://github.com/ln-e/icon-font-generator/blob/master/LICENSE)
